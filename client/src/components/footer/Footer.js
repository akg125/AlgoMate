...
const Footer = () => {
    ...
    return (
        <div className="footer">
            ...
            <div className="footer__section">
                <div className="footer__group">
                    <div className="footer__subSection" style={{ flex: 2 }}>
                        <h1>About</h1>
                        <p> I am an undergraduate student of IIT Kharagpur.<br />About Algozenith's Internal Hackathon<br /><br />AlgoMate - Your DSA Companion is created under  Algozenith's Internal Hackathon starting on 1st May 2022, extending upto two weeks. At AlgoMate, you get access to a powerful DSA search engine, tons of resources and many more. I hope you like it!</p>
                        <h1>Contact</h1>
                        <p className="footer__contact"><b>Address:</b> Indian Institute of Technology Kharagpur</p>
                        <p className="footer__contact"><b>Phone:</b> +91 99999xxxxx</p>
                        <a className="footer__contact" href="mailto:email@kgp.com"><b>Email:</b> email@kgp.com</a>
                    </div>
            ...
            <p className="footer__end">IIT Kharagpur © All Rights Reserved</p>
        </div>
    );
};
